...
TEST_F(VkLayerTest, MultiplaneImageSamplerConversionMismatch) {
    ...
    if (DeviceValidationVersion() >= VK_API_VERSION_1_1) {
        ...
        vkCreateSamplerYcbcrConversionFunction = (PFN_vkCreateSamplerYcbcrConversionKHR)vkGetDeviceProcAddr(m_device->handle(), "vkCreateSamplerYcbcrConversionKHR");
        vkDestroySamplerYcbcrConversionFunction = (PFN_vkDestroySamplerYcbcrConversionKHR)vkGetDeviceProcAddr(m_device->handle(), "vkDestroySamplerYcbcrConversionKHR");
    }
